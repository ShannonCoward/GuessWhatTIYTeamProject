...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-GuessWhatTIYTeamProject/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'AFAmazonS3Manager.framework'
  install_framework 'AFNetworking.framework'
  install_framework 'Alamofire.framework'
  install_framework 'AmazonS3RequestManager.framework'
fi
